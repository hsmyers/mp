 ...
 **  @file palette.c
 **  @author Hugh S. Myers
 **  @brief A collection of functions in aid of RGB palettes.
 **  @date Mon Jul 24 11:20:10 2017
 **
 **  This module provides the construction of dynamic palettes.
 **  Essentially a contiguous array of RGB values, which can be either loaded
 **  from a file or constructed dynamically.
 **
 **  @bug No known bugs.
 **/
 ...
 *
 * @param A pointer to an array of Rgb.
 ...
 * @details Given the name of a palette file of Rgb triples, read and load a palette.
 *
 * @param palname Name of palette file.
 * @return Returns an instance of array. A palette in this case.
 */
Array getColors( char *palname ) {
    ...
    while ( true ) {
        ...
        if ( ret == 3 ) {
            ...
            printf( "Read error in palette file: %s ret=%d\n", palname, ret );
            exit( 1 );
        }
    }
    fclose( fp );
 ...
 * Added possibility of intermediate colors on: Tue Jul 25 11:52:10 2017.
 *
