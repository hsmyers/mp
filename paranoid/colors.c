 ...
 **  @file colors.c
 **  @author Hugh S. Myers
 **  @brief A collection of functions in aid of fractal coloring
 **  @date Tue Jul 25 08:03:58 2017
 **
 **  @section DESCRIPTION
 **
 **  There are more ways to color a fractal than can be imagined. The routines
 **  presented/gathered here are just a few. This file is subject to frequent
 **  re-factorization as methods are determined, worked out and used.
 **
 **  @bug No known bugs.
 **/
